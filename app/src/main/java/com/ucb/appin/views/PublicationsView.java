...
public class PublicationsView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //View view = DataBindingUtil.inflate(inflater, R.layout.fragment_avisos_view, container, false).getRoot();

        /*FragmentAvisosViewBinding binding = DataBindingUtil.inflate(inflater,R.layout.fragment_avisos_view, container, false);
        binding.setAvisos(new AvisosBean("datos"));
